...
struct SettingsView: View {
    ...
    func generateData() {
       ...
       let burgerKingTransaction = AccountTransaction(name: "Burger King", transactionType: .debit, amount: transactionAmount, balance: balance, pending: nil, cleared: Date(), account: amegyAccount, tags: [ffTag])
       modelContext.insert(burgerKingTransaction)

       transactionAmount = -8.79
       balance = balance+transactionAmount
       let wendysTransaction: AccountTransaction = AccountTransaction(name: "Wendys", transactionType: .debit, amount: transactionAmount, balance: balance, pending: nil, cleared: Date(), account: amegyAccount, tags: [ffTag])
       modelContext.insert(wendysTransaction)
       
       transactionAmount = -88.34
       balance = balance+transactionAmount
       let cvsTransaction = AccountTransaction(name: "CVS", transactionType: .debit, amount: transactionAmount, balance: balance, pending: nil, cleared: Date(), account: amegyAccount, tags: [medicalTag, pharmacyTag])
       modelContext.insert(cvsTransaction)
               
       transactionAmount = -10.81
       balance = balance + transactionAmount
       
       let discordTransaction: AccountTransaction = AccountTransaction(name: "Discord", transactionType: .debit, amount: transactionAmount, balance: balance, pending: nil, cleared: nil, account: amegyAccount, tags: [billsTag])
       modelContext.insert(discordTransaction)
       
       transactionAmount = -36.81
       balance = balance + transactionAmount
       
       let fitnessTransaction: AccountTransaction = AccountTransaction(name: "Fitness", transactionType: .debit, amount: transactionAmount, balance: balance, pending: Date(), cleared: nil, account: amegyAccount, tags: [billsTag])
       modelContext.insert(fitnessTransaction)
       
       transactionAmount = 2318.79
       balance = balance + transactionAmount
       
       let paydayTransaction: AccountTransaction = AccountTransaction(name: "Payday", transactionType: .credit, amount: transactionAmount, balance: balance, pending: nil, cleared: Date(), account: amegyAccount, tags: [incomeTag])
